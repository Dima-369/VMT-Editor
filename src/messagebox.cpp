...
{
#ifdef Q_OS_WIN
	//SendMessage( (HWND)msgBox->winId(), WM_SETICON, ICON_BIG, (LPARAM)qt_pixmapToWinHICON(QPixmap(":/icons/vmt_256")));
												...
												QMessageBox::StandardButton defaultButton)
{
    ...
    #ifdef Q_OS_WIN
		//SendMessage( (HWND)staticMsg->winId(), WM_SETICON, ICON_BIG, (LPARAM)qt_pixmapToWinHICON(QPixmap(":/icons/vmt_256")));
		//SendMessage( (HWND)staticMsg->winId(), WM_SETICON, ICON_SMALL, (LPARAM)qt_pixmapToWinHICON(QPixmap(":/icons/vmt_16")));
    #endif
